...
local subliminal = '/home/l/.local/bin/subliminal'
--=============================================================================
-->>    SUBTITLE LANGUAGE:
--=============================================================================
...
--          { '--legendastv', 'USERNAME', 'PASSWORD' },
          { '--opensubtitles', 'ghd9', 'TMN2FBp5zQ3S8X@' },
          -- { '--subscenter', 'ghd9', 'TMN2FBp5zQ3S8X@' },
}
--=============================================================================
-->>    ADDITIONAL OPTIONS:
--=============================================================================
...
mp.add_key_binding('m', 'download_subs2', download_subs2)
