...
(when (eq system-type 'darwin)
  ...
  ;; display.
  (defvar salih/alpha-background 0.4
    "Frame background alpha (0.0-1.0). Lower = more glass.")
  (defvar salih/ns-background-blur 50
    "macOS background blur radius (px). 0 = no blur, 30+ = strong glass.")
  (setq salih/alpha-background 0.4
        salih/ns-background-blur 50)

  (defconst salih/--glass-face-palette
    '((default                         :background "#50638f" :foreground "#d7e2ff")
      (fringe                          :background "#50638f")
      (line-number                     :background "#50638f" :foreground "#aab7dc" :slant normal)
      (line-number-current-line        :background "#50638f" :foreground "#eef3ff" :slant normal)
      (hl-line                         :background "#5a6d9a")
      (mode-line                       :background "#42547d" :foreground "#d7e2ff" :family "Pragmasevka")
      (mode-line-active                :background "#42547d" :foreground "#d7e2ff" :family "Pragmasevka")
      (mode-line-inactive              :background "#2e3a59" :foreground "#aab7dc" :family "Pragmasevka")
      (header-line                     :background "#50638f" :foreground "#d7e2ff")
      (vertical-border                 :background "#50638f" :foreground "#7f91bd")
      (window-divider                  :foreground "#7f91bd")
      (window-divider-first-pixel      :foreground "#7f91bd")
      (window-divider-last-pixel       :foreground "#7f91bd")
      (cursor                          :background "#b8fff5")
      (region                          :background "#6b7fad")
      (minibuffer-prompt               :foreground "#9db8ff" :weight bold)
      (font-lock-comment-face          :foreground "#b4c1e8" :slant italic)
      (font-lock-comment-delimiter-face :foreground "#b4c1e8" :slant italic)
      (font-lock-doc-face              :foreground "#b4c1e8" :slant italic)
      (font-lock-doc-markup-face       :foreground "#c7b5ff" :slant italic)
      (font-lock-keyword-face          :foreground "#9db8ff" :weight bold)
      (font-lock-builtin-face          :foreground "#9ee7f0" :weight bold)
      (font-lock-string-face           :foreground "#b7e3c0")
      (font-lock-function-name-face    :foreground "#d0dcff")
      (font-lock-variable-name-face    :foreground "#f0d7a0" :slant italic)
      (font-lock-type-face             :foreground "#c7b5ff" :slant italic)
      (font-lock-constant-face         :foreground "#ffb37a")
      (font-lock-warning-face          :foreground "#ff8f9f" :weight bold)
      (isearch                         :background "#f4d38a" :foreground "#1a2438" :weight bold)
      (lazy-highlight                  :background "#7087b9" :foreground "#f1f5ff")
      (show-paren-match                :background "#9ee7f0" :foreground "#162136" :weight bold)
      (doom-dashboard-banner           :foreground "#aebcff")
      (doom-dashboard-menu-title       :foreground "#9db8ff" :weight bold)
      (doom-dashboard-menu-desc        :foreground "#d7e2ff")
      (corfu-default                   :background "#42547d" :foreground "#d7e2ff")
      (vertico-current                 :background "#5a6d9a" :foreground "#f1f5ff"))
