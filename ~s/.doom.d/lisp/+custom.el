...
(after! org
  ...
  (custom-set-faces
   ...
   '(org-level-1 ((t (:inherit outline-1 :height 1.55 :weight bold :family "JetBrains Mono"))))
   '(org-level-2 ((t (:inherit outline-2 :height 1.3  :weight bold :family "JetBrains Mono"))))
