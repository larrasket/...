;;; mine-theme.el --- mine light theme -*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)

;;; Variables
(defgroup mine-theme nil
  "Options for the `mine' theme."
  :group 'doom-themes)

(defcustom mine-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'mine-theme
  :type 'boolean)

(defcustom mine-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'mine-theme
  :type 'boolean)

(defcustom mine-comment-bg mine-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'mine-theme
  :type 'boolean)

(defcustom mine-padded-modeline doom-themes-padded-modeline
...
;;; Theme definition
(def-doom-theme mine
  "A light theme inspired by mine light"
...
;;;; Colors
  ...
  ((bg         '("#F5F5F9" "color-255" "black"        ))
   ...
   (base2      '("#BABAC1" "color-152" "brightblack"  ))
   (base3      '("#BABAC1" "color-103" "brightblack"  ))
...
;;;; face categories -- required for all themes
   ...
   (selection      bg-blue)
   (builtin        blue)
   (comments       (if mine-brighter-comments cyan grey))
   (doc-comments   (doom-darken (if mine-brighter-comments cyan green) 0.25))
   (constants      magenta)
   (functions      yellow)
   (keywords       red)
   (methods        cyan)
   ...
   ;; custom categories
   (hidden bg)
   (-modeline-dark mine-brighter-modeline)
   (-modeline-bright -modeline-dark)
   (-modeline-pad
    (when mine-padded-modeline
      (if (integerp mine-padded-modeline) mine-padded-modeline 4)))
  ...
  (((font-lock-comment-face &override)
    :slant 'italic
    :background (if mine-comment-bg (doom-darken bg 0.05)))
